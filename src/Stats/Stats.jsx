...
const Stats = () => {
  return (
    // rating section
    <section className="bg-linear-to-r from-[#4F39F6] to-[#9514FA] mb-100">
      {/* rating container */}
      <div className="rating-container flex flex-row max-w-2xl lg:max-w-5xl w-full mx-auto py-8 lg:py-15 justify-between">
